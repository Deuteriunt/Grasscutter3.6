...
public final class FKJCFGLHNPMOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.FKJCFGLHNPMOuterClass.FKJCFGLHNPM result) {
        if (stageInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.FKJCFGLHNPMOuterClass.FKJCFGLHNPM result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 74: {
                emu.grasscutter.net.proto.DMMAGIEOPDGOuterClass.DMMAGIEOPDG m =
                    input.readMessage(
                        emu.grasscutter.net.proto.DMMAGIEOPDGOuterClass.DMMAGIEOPDG.parser(),
                        extensionRegistry);
                if (stageInfoListBuilder_ == null) {
                  ensureStageInfoListIsMutable();
