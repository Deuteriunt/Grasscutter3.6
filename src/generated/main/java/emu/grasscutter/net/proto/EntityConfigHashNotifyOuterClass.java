...
public final class EntityConfigHashNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.EntityConfigHashNotifyOuterClass.EntityConfigHashNotify result) {
        if (avatarEntryListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.EntityConfigHashNotifyOuterClass.EntityConfigHashNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.grasscutter.net.proto.EntityConfigHashEntryOuterClass.EntityConfigHashEntry m =
                    input.readMessage(
                        emu.grasscutter.net.proto.EntityConfigHashEntryOuterClass.EntityConfigHashEntry.parser(),
                        extensionRegistry);
                if (combatEntryListBuilder_ == null) {
                  ensureCombatEntryListIsMutable();
